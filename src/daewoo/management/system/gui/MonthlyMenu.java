...
/**
 * This is the class of the menu of drivers that are monthly paid extending
 * JFrame and implementing ActionListener
 *
 */
public class MonthlyMenu extends JFrame implements ActionListener {

    JLabel heading = new JLabel("Monthly salaried Drivers");
    ...
    /**
     * This is the default constructor of the class MainMenu
     */
    public MonthlyMenu() {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch (s) {
            ...
            case "Delete Driver's data":
                ...
                JOptionPane.showMessageDialog(null, SalariedDriver.deleteDriver(Integer.parseInt(text)));
                break;
    ...
    /**
     * This is the inner class AddDriver to implement the add driver button
     */
    public class AddDriver extends JFrame {
        ...
        JTextField _salary = new JTextField("Enter Driver's Monthly salary");
        JButton close1 = new JButton("Close");

        /**
         * This is the default constructor of the inner class AddDriver
         */
        public AddDriver() {
            super("Daewoo Management System");
            setLayout(new BorderLayout());
            ...
            MouseAdapter m_id = new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    if (SalariedDriver.checkID(id_c) == true) {
                        _id.setText(Integer.toString(id_c));
                    } else if (SalariedDriver.checkID(id_c) == false) {
            ...
            MouseAdapter m_salary = new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    _salary.setText(JOptionPane.showInputDialog("Enter monthly salary:"));
                }
            };
    ...
    public class ViewDriver extends JFrame {
        ...
        JLabel heading1 = new JLabel("Monthly Driver's data");
        JButton close1 = new JButton("Close");
        JTextArea text_area = new JTextArea();

        /**
         * This is the default constructor of the ViewDriver class
         */
        public ViewDriver() {
            super("Daewoo Management System");
            setLayout(new BorderLayout());
            ...
            text_area.setText("ID\tName\t\tMobile No\t\tMonthly salary\n\n" + SalariedDriver.viewDriver());
        }
    }
    ...
    public class SearchDriver extends JFrame {
        ...
        public SearchDriver() {
            ...
            sd = SalariedDriver.searchDriver(id_c);
            text_area.setText(sd.toString());
            add(text_area, BorderLayout.CENTER);
        }
    }

    /**
     * This is the inner class SearchDriverN implementing search driver by name
     * button
     */
    public class SearchDriverN extends JFrame {
        ...
        /**
         * This is the default constructor of the class SearchDriverN
         */
        public SearchDriverN() {
            ...
            text_area.setText(SalariedDriver.searchDriver(s));
            add(text_area, BorderLayout.CENTER);
        }
    }
        ...
        public UpdateDriver() {
            ...
            ActionListener u_name = new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    JOptionPane.showMessageDialog(null, SalariedDriver.updateDriver(uid, messege));
                }
            };
            ...
            ActionListener u_salary = new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    String messege = JOptionPane.showInputDialog("Enter monthly salary: ");
                    JOptionPane.showMessageDialog(null, SalariedDriver.updateDriver(uid, messege));
                }
            };
